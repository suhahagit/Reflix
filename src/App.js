...
class App extends Component {
  ...
  updateRented = (id) => {
    ...
    movieData.find(m => m.id === id).isRented = !movieData[id].isRented
      ...
      <Router>
        <div id='container'>
          <div className='head'>
            ...
            <Link to="/catalog" className='mainLinks'>Catalog</Link>
            <div className='logo'>REFLIX</div>
          </div>
          <div className='content'>
            <Route path="/" exact component={Landing} />
            <Route path="/catalog" exact render={() => <Catalog movieData = {this.state.movieData} updateRented = {this.updateRented}/>}/>
            <Route path="/catalog/:movieId" exact render={({ match }) => <MovieDetail match={match} movieData = {this.state.movieData}/>} />
          </div>
        </div>
      </Router>
    );
